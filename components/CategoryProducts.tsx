      ...
      <div className="flex flex-col md:min-w-40 border ">
        {categories?.map((item) => (
          <Button
            ...
            key={item?._id}
            className={`
            bg-transparent border-0 p-0 rounded-none text-darkColor shadow-none
            hover:bg-orange hover:text-white font-semibold hoverEffect border-b 
            last:border-b-0 capitalize transition-colors ${
